  ...
  return (
      <footer className="footer">
        <div className="footer__logos">
          <svg xmlns="http://www.w3.org/2000/svg" width="139" height="20" className="footer__logos--mainlogo"><defs>
        ...
        <nav className="footer__nav">
          <ul className="footer__nav--list">
            <li className="footer__nav--list-item">About Us</li>
            ...
            <li className="footer__nav--list-item">Privacy Policy</li>
          </ul>
        </nav>
